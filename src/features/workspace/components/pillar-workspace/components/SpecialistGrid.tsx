                    ...
                    <div className="w-full lg:w-5/12 space-y-6">
                        <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/[0.02] shadow-2xl shadow-black/40">
                            ...
                            <div className="mt-5 flex items-center gap-4">
                                <svg width="600" height="88" className="transform -rotate-90">
                                    <circle cx="44" cy="44" r="41" fill="none" stroke="rgba(255,255,255,0.06)" strokeWidth="3"></circle>
                                    <circle cx="44" cy="44" r="41" fill="none" stroke={scoreGeral >= 70 ? '#10b981' : scoreGeral >= 40 ? '#f59e0b' : '#ef4444'} strokeWidth="3" strokeDasharray="257.610597594363" strokeDashoffset={257.610597594363 * (1 - (Math.max(0, Math.min(100, scoreGeral || 0)) / 100))} strokeLinecap="round" className="transition-all duration-700"></circle>
                                    <text x="44" y="44" textAnchor="middle" dominantBaseline="central" className="fill-white text-[11px] font-bold" transform="rotate(90 44 44)">{scoreGeral}</text>
                                </svg>
